...
class StudentClassesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final classes = StudentMockData.myClasses;
      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              Text('Lớp học của tôi', style: AppTextStyles.displayLg(c.foreground).copyWith(fontSize: 22)),
              Text('HK2 2024–2025 · ${classes.length} lớp', style: AppTextStyles.bodySm(c.mutedForeground)),
            ],
          ),
        ),
        Padding(
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  child: const Icon(Icons.menu_book, color: Color(0xFF1E56A0), size: 22),
                ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(cls.id, style: AppTextStyles.mono(c.primary, fontSize: 11)),
                      ),
                      const SizedBox(height: 3),
                      Text(cls.name, style: AppTextStyles.displaySm(c.foreground)),
                      Text(cls.lecturer, style: AppTextStyles.bodyXs(c.mutedForeground)),
                ...
                return Expanded(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border(
                        right: i < stats.length - 1 ? BorderSide(color: c.border) : BorderSide.none,
                      ),
                    ),
                    child: Column(
                      children: [
                        Text(s['v'] as String,
                            style: TextStyle(fontFamily: 'Nunito', fontWeight: FontWeight.w800, fontSize: 16, color: s['c'] as Color)),
                        Text(s['l'] as String, style: AppTextStyles.bodyXs(c.mutedForeground).copyWith(fontSize: 10)),
                      ],
                    ),
                  ),
                );
