      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              Text('Sự kiện', style: AppTextStyles.displayLg(c.foreground).copyWith(fontSize: 22)),
              Text('Khám phá & đăng ký sự kiện', style: AppTextStyles.bodySm(c.mutedForeground)),
            ],
          ),
        ),
        Padding(
        ...
        children: [
          Row(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.event, color: Color(0xFF7C3AED), size: 22),
              ),
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(event.name, style: AppTextStyles.displaySm(c.foreground)),
          ...
          Row(
            children: [
              ...
              const Spacer(),
              event.registered
                  ? OutlinedButton(onPressed: () {}, child: const Text('Xem chi tiết'))
                  : ElevatedButton(onPressed: () {}, child: const Text('Đăng ký ngay')),
            ],
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text('Khám phá thêm sự kiện', style: AppTextStyles.displayXs(c.foreground).copyWith(fontSize: 14)),
          ...
          const SizedBox(height: 12),
          OutlinedButton(onPressed: () {}, child: const Text('Tìm kiếm sự kiện')),
        ],
      ),
    );
  }
